...
// 20160274_Practice_7_1Dlg.cpp : 구현 파일
//

#include "stdafx.h"
#include "20160274_Practice_7_1.h"
#include "20160274_Practice_7_1Dlg.h"
...
// CMy20160274_Practice_7_1Dlg 대화 상자



CMy20160274_Practice_7_1Dlg::CMy20160274_Practice_7_1Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_MY20160274_PRACTICE_7_1_DIALOG, pParent)
...
void CMy20160274_Practice_7_1Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CMy20160274_Practice_7_1Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_INSERT, &CMy20160274_Practice_7_1Dlg::OnClickedButtonInsert)
	ON_NOTIFY(LVN_ITEMCHANGED, IDC_LIST_STUDENT, &CMy20160274_Practice_7_1Dlg::OnItemchangedListStudent)
	ON_BN_CLICKED(IDC_BUTTON_MODIFY, &CMy20160274_Practice_7_1Dlg::OnClickedButtonModify)
	ON_BN_CLICKED(IDC_BUTTON_DELETE, &CMy20160274_Practice_7_1Dlg::OnClickedButtonDelete)
	ON_BN_CLICKED(IDC_BUTTON_RESET, &CMy20160274_Practice_7_1Dlg::OnClickedButtonReset)
	ON_CBN_SELCHANGE(IDC_COMBO_STYLE, &CMy20160274_Practice_7_1Dlg::OnSelchangeComboStyle)
END_MESSAGE_MAP()


// CMy20160274_Practice_7_1Dlg 메시지 처리기

BOOL CMy20160274_Practice_7_1Dlg::OnInitDialog()
{
...
void CMy20160274_Practice_7_1Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMy20160274_Practice_7_1Dlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CMy20160274_Practice_7_1Dlg::OnQueryDragIcon()
{
...
void CMy20160274_Practice_7_1Dlg::OnClickedButtonInsert()
{
...
void CMy20160274_Practice_7_1Dlg::OnItemchangedListStudent(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void CMy20160274_Practice_7_1Dlg::OnClickedButtonModify()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	UpdateData(TRUE);
...
void CMy20160274_Practice_7_1Dlg::OnClickedButtonDelete()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	if (m_nSelectedItem >= 0) {
...
void CMy20160274_Practice_7_1Dlg::OnClickedButtonReset()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	m_strDept.Empty();
	m_strID.Empty();
...
void CMy20160274_Practice_7_1Dlg::OnSelchangeComboStyle()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
