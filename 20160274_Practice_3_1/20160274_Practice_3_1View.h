...
// 20160274_Practice_3_1View.h : CMy20160274_Practice_3_1View 클래스의 인터페이스
//
...
protected:
	DECLARE_MESSAGE_MAP()
public:
	afx_msg int OnCreate(LPCREATESTRUCT lpCreateStruct);		// OnCreate 핸들러 함수
	afx_msg void OnLButtonDblClk(UINT nFlags, CPoint point);	// OnLButtonDblClk 핸들러 함수
	afx_msg void OnDestroy();									// OnDestroy 핸들러 함수
};

#ifndef _DEBUG  // 20160274_Practice_3_1View.cpp의 디버그 버전
