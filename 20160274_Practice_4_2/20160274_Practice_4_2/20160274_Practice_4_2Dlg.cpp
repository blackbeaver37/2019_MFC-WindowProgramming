...
// 20160274_Practice_4_2Dlg.cpp : 구현 파일
//

#include "stdafx.h"
#include "20160274_Practice_4_2.h"
#include "20160274_Practice_4_2Dlg.h"
...
// CMy20160274_Practice_4_2Dlg 대화 상자



CMy20160274_Practice_4_2Dlg::CMy20160274_Practice_4_2Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_MY20160274_PRACTICE_4_2_DIALOG, pParent)
	, m_strYear(_T(""))
	, m_strSecond(_T(""))
	, m_strMonth(_T(""))
	, m_strMinute(_T(""))
...
void CMy20160274_Practice_4_2Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CMy20160274_Practice_4_2Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_COMMAND(IDC_RADIO_12, &CMy20160274_Practice_4_2Dlg::OnRadio12)
	ON_COMMAND(IDC_RADIO_24, &CMy20160274_Practice_4_2Dlg::OnRadio24)
	ON_BN_CLICKED(IDC_CHECK_YEAR, &CMy20160274_Practice_4_2Dlg::OnClickedCheckYear)
	ON_BN_CLICKED(IDC_CHECK_HOUR, &CMy20160274_Practice_4_2Dlg::OnClickedCheckHour)
	ON_WM_TIMER()
	ON_BN_CLICKED(IDC_BUTTON_HELP, &CMy20160274_Practice_4_2Dlg::OnClickedButtonHelp)
END_MESSAGE_MAP()


// CMy20160274_Practice_4_2Dlg 메시지 처리기

BOOL CMy20160274_Practice_4_2Dlg::OnInitDialog()
{
...
void CMy20160274_Practice_4_2Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMy20160274_Practice_4_2Dlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CMy20160274_Practice_4_2Dlg::OnQueryDragIcon()
{
...
void CMy20160274_Practice_4_2Dlg::OnRadio12()
{
...
void CMy20160274_Practice_4_2Dlg::OnRadio24()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	m_bRadioClockType = false;
}
...
void CMy20160274_Practice_4_2Dlg::OnClickedCheckYear()
{
...
void CMy20160274_Practice_4_2Dlg::OnClickedCheckHour()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
void CMy20160274_Practice_4_2Dlg::OnTimer(UINT_PTR nIDEvent)
{
...
void CMy20160274_Practice_4_2Dlg::OnClickedButtonHelp()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
