	...
	: m_nViewFlag(0)
{
	...
	m_nViewFlag = FIRST_VIEW;				// 처음에 FIRST_VIEW로 설정.
...
{
	m_pFirstView = (CMy20160274_Practice_10_3View*)GetActiveView();	// 현재 활성화 되어있는 뷰를 얻는다.

	if (m_pSecondView == NULL)				// 객체가 아직 생성된 적이 없다면 if 블록 실행
	{
